  ...
  return (
    <div className='mt-5 mx-5'>
      ...
      <div className="flex flex-col gap-1 md:gap-1.5 lg:gap-2 p-1 mt-2">
        {
          proj.map((proj) => (<div className='flex-col bg-purple-50 dark:bg-slate-950 dark:text-white rounded-lg border-1 border-gray-500 dark:border-gray-700 p-1 cursor-pointer hover:transform-3d mt-2 sm:mt-2 md:mt-3 transition-transform duration-300 ease-in-out hover:scale-101 shadow-lg sm:shadow-sm' key={proj.id} onClick={() => handleLinkClick(proj.liveLink)}>

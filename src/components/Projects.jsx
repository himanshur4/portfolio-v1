  ...
  return (
    <div className='mt-5 mx-5'>
      ...
      <div className="flex flex-col gap-1 md:gap-1.5 lg:gap-2 p-1 mt-2">
        {
          proj.map((proj) => (<div className='flex-col bg-gray-50 dark:bg-zinc-950 border border-solid dark:border-zinc-500 shadow-[3px_4px_4px_#777777] dark:shadow-[3px_4px_3px_#555555] p-1 cursor-pointer hover:transform-3d mt-2 sm:mt-2 md:mt-3 transition-transform duration-300 ease-in-out hover:shadow-[3px_4px_0px_#000000] hover:dark:shadow-[3px_4px_0px_#aaaaaa] rounded' key={proj.id} onClick={() => handleLinkClick(proj.liveLink)}>
        ...
        <div className='flex justify-center items-center'>
          <button className='text-xs sm:text-sm text-gray-800 dark:text-gray-200 hover:underline cursor-pointer border border-solid dark:border-zinc-500 shadow-[2px_3px_2px_#444444] dark:shadow-[1px_2px_2px_#555555] p-1  w-fit px-4   mt-5  rounded' onClick={() => setShowAllProj((prev) => !prev)}>

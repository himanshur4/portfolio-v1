    ...
    <div className='mt-5 mx-5'>
      ...
      <div className="flex flex-col gap-1 md:gap-1.5 lg:gap-2 p-1 mt-2">
        ...
        <div className='flex justify-center items-center'>
          <button className='text-xs sm:text-sm text-gray-800 dark:text-gray-200 hover:underline cursor-pointer border border-solid dark:border-zinc-500 shadow-[2px_3px_1px_#444444] dark:shadow-[1px_2px_0px_#555555] p-1  w-fit px-4   mt-5  rounded' onClick={() => setShowAllProj((prev) => !prev)}>

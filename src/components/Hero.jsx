  ...
  return (
    <div className='flex flex-col mt-5 mx-4'>
      <div className="flex flex-col items-start md:items-center md:gap-4 md:flex-row gap-2">
        <img src="/himImage.jpg" className='w-15 sm:w-17 md:w-28 lg:w-30 rounded-full ml-2 border-1 dark:border-0' alt="profilePic" />
        <div className="flex-col mt-1">
          ...
          <p className='text-xs sm:text-sm tracking-tight text-gray-900 dark:text-gray-300 ml-2 '>Pre-final year Computer Science student passionate about building scalable web apps, learning new technologies, and breaking down complex ideas into clean, working solutions.</p>
          </div>
      </div>
    </div>
  )

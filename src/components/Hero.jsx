    ...
    <div className='flex flex-col mt-5 mx-4'>
      <div className="flex flex-col items-start md:items-center md:gap-4 md:flex-row gap-2">
        ...
        <div className="flex-col mt-1">
          ...
          <p className='text-xs sm:text-sm tracking-tight text-gray-900 dark:text-gray-300 mr-1 sm:mr-3 ml-2 '>Pre-final year Computer Science student passionate about building scalable web apps, learning new technologies, and breaking down complex ideas into clean, working solutions.</p>
          </div>
      </div>
    </div>
  )

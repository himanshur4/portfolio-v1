    ...
    <div className='flex flex-col mt-5 mx-4'>
      <div className="flex flex-col items-start md:items-center md:gap-4 md:flex-row gap-2">
        ...
        <div className="flex-col mt-1">
          <h1 className='text-xl tracking-tight font-semibold ml-2'>Hii👋 I am <span className='bg-clip-text text-transparent bg-gradient-to-r from-[#FF512F] via-[#FF6F5E] to-[#DD2476]'>Himanshu.</span></h1>

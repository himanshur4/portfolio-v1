...
const ContactCard = () => {
    ...
    return (
        <div className='flex-col justify-center items-start w-full sm:w-3/4 bg-gray-50 dark:bg-zinc-950 p-2 border border-solid dark:border-stone-500 shadow-[5px_5px_0px_#000000] dark:shadow-[4px_4px_0px_#999] mt-2 mb-4 sm:px-3 md:px-4 lg:px-6 rounded'>

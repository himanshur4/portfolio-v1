...
const ContactCard = () => {
    ...
    return (
        <div className='flex-col justify-center items-start w-full sm:w-3/4 bg-indigo-50 dark:bg-slate-950 p-2 rounded-lg sm:px-3 md:px-4 lg:px-6 border-1 border-gray-700'>
